...
function joints_rss_dashboard_widget() {
	if(function_exists('fetch_feed')) {
		...
		$feed = fetch_feed('http://mondo.com/feed/rss/');        // specify the source feed
...
function joints_custom_admin_footer() {
	_e('<span id="footer-thankyou">Developed by <a href="http://www.mondolabs.com" target="_blank">MondoLabs</a></span>.', 'jointswp');
}
